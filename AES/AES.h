...
class AES_Encrypt
{
	...
	string w[60];
	string keys[15];
	string fixedMatrix[4][4] ={
					{"02","03","01","01"},
					{"01","02","03","01"},
					{"01","01","02","03"},
					{"03","01","01","02"}};

	string fixedMatrixd[4][4] ={ 
					{"0e","0b","0d","09"},
					{"09","0e","0b","0d"},
					{"0d","09","0e","0b"},
					{"0b","0d","09","0e"}};
...
public:
	...
	//-------------------------------------Substitute Bytes------------------------------------
	string** SubstituteBytes(string** arr, char);
	//-----------------------------------------------------------------------------------------

	//-------------------------------------Shift Rows------------------------------------------
	void leftshift(string arr[], int size);
	void LeftShiftNtTime(string arr[], int size, int k);
	string** ShiftRows(string** D2, char c);
	//-----------------------------------------------------------------------------------------

	//-------------------------------------Mix Column------------------------------------------
	string** mixColumns(string mt1[4][4], string** mt2);
	//-----------------------------------------------------------------------------------------
